...
var SimpleConfirm = (function() {
  ...
  ConfirmItem.prototype = {
    ...
    buildHTML: function() {
      ...
      this.confirm_btn.className = 'btn btn-warning sc-confirm';
      ...
      this.cancel_btn.className = 'btn btn-primary sc-cancel';
    ...
    setupListeners: function() {
      if (typeof addEventListener === 'function') {
        ...
        this.confirm_btn.addEventListener(
          'click',
          function(e) {
            e.preventDefault();
            this.hide();
        ...
        this.cancel_btn.addEventListener(
          'click',
          function(e) {
            e.preventDefault();
            this.hide();
